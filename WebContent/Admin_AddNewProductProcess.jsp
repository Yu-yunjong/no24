			...
			<table border=0 cellspacing=0 cellpadding=2 >
				<tr>
					<td>
						...
						if(group == null)
							out.println("<h3>관리자만 접근 가능한 페이지입니다. 로그인 후 다시 시도하시기 바랍니다.</h3>");
						else {
							...
							try {
								...
								if(imgName == null)
									...
									out.println("<h3>그룹 or 카테고리 선택 후, 다시 상품을 등록해주세요.</h3>");
								else {
									int count = 0;
									...
									if(count == 1){
								        ...
								        request.setAttribute("title", "** 등록된 상품 **"); 	        
