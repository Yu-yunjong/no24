...
<html>
	<head>
		...
		ResultSet rs = DB.selectUserInfo(userID);
		...
		<!-- 메인 상자 추가 -->
		<form action = "Admin_UserInfoChangeProcess.jsp" method ="POST">
			<div id="mainbox" >
				...
				<table border=0 cellspacing=0 cellpadding=2 >
					...
					<tr>
						<td>
					 	...
					 	<td>
							<% out.println(userID); %><% out.println("<input type=\"text\"name=\"userID\" hidden value=\"" + userID +"\">"); %>
						</td>
					</tr>
					<tr>
						<td>
