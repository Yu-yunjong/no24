		...
		<form action = "" method ="POST">
			<div id="mainboxOrderList">
				...
				<table border="3" width="1600" >
					<tr bgcolor=#CCCCCC><td><h3>주문번호</h3></td><td><h3>고객ID</h3></td><td><h3>상품명</h3></td><td><h3>수량</h3></td>
					...
					if(id == null)
						...
						String ono[] = new String[rowsCount], pno[] = new String[rowsCount], pname[] = new String[rowsCount], 
								...
								ostatus[] = new String[rowsCount], oaddress[] = new String[rowsCount], uid[] = new String[rowsCount];
